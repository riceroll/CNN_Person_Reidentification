...
weights = './models/RIDLT_iter_20000.caffemodel'
assert os.path.exists(weights)
training_set = './train.txt'

NUM_STYLE_LABELS = 156
style_labels=[]
for i in range(NUM_STYLE_LABELS):
    style_labels.append(str(i))
...
#     Convolutionary layer connected with ReLU layer
...
def style_net(train=True, learn_all=False, source=None):
    ...
    return caffenet(data=style_data, label=style_label, train=train,
                    ...
                    classifier_name='fc8_ilids_prp_real',
                    learn_all=learn_all)
...
end_to_end_net = style_net(train=True, learn_all=True, source=training_set)
